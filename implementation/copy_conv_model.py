...
from optimization import nesterov_rmsprop_multiple, logsumexp
...
class CopyConvolutionalAttentionalModel(object):
    ...
    def __init_parameter(self, empirical_name_dist):
        ...
        conv_layer1_code = np.random.randn(self.hyperparameters["conv_layer1_nfilters"], 1, self.hyperparameters["layer1_window_size"], self.D) * 10 ** self.hyperparameters["log_layer1_init_scale"]
    ...
    def __get_model_likelihood_for_sentence(self, sentence, name_contexts, do_dropout=False, dropout_rate=0.5):
        ...
        copy_pos_probs = T.nnet.softmax(copy_l3_out)  # =  size of sentence
        ...
        attention_weights = T.nnet.softmax(att_l3_out)  # = size of sentence
